...
export type ConfigSubscriptionsArgs = {
  cursor?: InputMaybe<SubWhereUniqueInput>;
  orderBy?: Array<SubOrderByInput>;
...
export type ConfigSubscriptionsCountArgs = {
  where?: SubWhereInput;
};

export type ConfigCreateInput = {
  privacyPolicyUrl?: InputMaybe<Scalars['String']['input']>;
  subscriptions?: InputMaybe<SubRelateToManyForCreateInput>;
...
export type ConfigUpdateInput = {
  privacyPolicyUrl?: InputMaybe<Scalars['String']['input']>;
  subscriptions?: InputMaybe<SubRelateToManyForUpdateInput>;
  termsAndConditionsUrl?: InputMaybe<Scalars['String']['input']>;
};
...
export type ConfigWhereInput = {
  ...
  subscriptions?: InputMaybe<SubManyRelationFilter>;
...
export type Mutation = {
  ...
  createSub?: Maybe<Sub>;
  createSubs?: Maybe<Array<Maybe<Sub>>>;
  ...
  deleteSub?: Maybe<Sub>;
  deleteSubs?: Maybe<Array<Maybe<Sub>>>;
  ...
  updateSub?: Maybe<Sub>;
  updateSubs?: Maybe<Array<Maybe<Sub>>>;
...
export type MutationCreateSubsArgs = {
  data: Array<SubCreateInput>;
};
...
export type MutationDeleteSubsArgs = {
  where: Array<SubWhereUniqueInput>;
};
...
export type MutationUpdateSubsArgs = {
  data: Array<SubUpdateArgs>;
};
...
export type Query = {
  ...
  story?: Maybe<Story>;
  sub?: Maybe<Sub>;
  subs?: Maybe<Array<Sub>>;
  subsCount?: Maybe<Scalars['Int']['output']>;
  user?: Maybe<User>;
...
export type QuerySubsCountArgs = {
  where?: SubWhereInput;
};
...
export type Sub = {
  ...
  billingPeriod?: Maybe<SubBillingPeriodType>;
  id: Scalars['ID']['output'];
  title?: Maybe<Scalars['String']['output']>;
};

export enum SubBillingPeriodType {
  Monthly = 'Monthly',
  Yearly = 'Yearly'
}

export type SubBillingPeriodTypeNullableFilter = {
  equals?: InputMaybe<SubBillingPeriodType>;
  in?: InputMaybe<Array<SubBillingPeriodType>>;
  not?: InputMaybe<SubBillingPeriodTypeNullableFilter>;
  notIn?: InputMaybe<Array<SubBillingPeriodType>>;
};

export type SubCreateInput = {
  appleProductId?: InputMaybe<Scalars['String']['input']>;
  billingPeriod?: InputMaybe<SubBillingPeriodType>;
  title?: InputMaybe<Scalars['String']['input']>;
};

export type SubManyRelationFilter = {
...
export type SubOrderByInput = {
  appleProductId?: InputMaybe<OrderDirection>;
  billingPeriod?: InputMaybe<OrderDirection>;
  id?: InputMaybe<OrderDirection>;
  title?: InputMaybe<OrderDirection>;
};

export type SubRelateToManyForCreateInput = {
  connect?: InputMaybe<Array<SubWhereUniqueInput>>;
  create?: InputMaybe<Array<SubCreateInput>>;
};

export type SubRelateToManyForUpdateInput = {
  connect?: InputMaybe<Array<SubWhereUniqueInput>>;
  create?: InputMaybe<Array<SubCreateInput>>;
...
export type SubWhereInput = {
  ...
  appleProductId?: InputMaybe<StringFilter>;
  billingPeriod?: InputMaybe<SubBillingPeriodTypeNullableFilter>;
  id?: InputMaybe<IdFilter>;
  title?: InputMaybe<StringFilter>;
};
...
export type OnUserStoriesCountUpdated = { userStoriesCountUpdated?: number | null };
 ...
 * });
 */
export function useOnUserStoriesCountUpdated(baseOptions: Apollo.SubscriptionHookOptions<OnUserStoriesCountUpdated, OnUserStoriesCountUpdatedVariables> & ({ variables: OnUserStoriesCountUpdatedVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<OnUserStoriesCountUpdated, OnUserStoriesCountUpdatedVariables>(OnUserStoriesCountUpdatedDocument, options);
      }
export type OnUserStoriesCountUpdatedHookResult = ReturnType<typeof useOnUserStoriesCountUpdated>;
export type OnUserStoriesCountUpdatedSubscriptionResult = Apollo.SubscriptionResult<OnUserStoriesCountUpdated>;